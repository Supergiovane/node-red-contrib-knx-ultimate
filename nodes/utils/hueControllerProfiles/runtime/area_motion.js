// Canonical private runtime profile for HUE Controller: area_motion.
...
module.exports = function (RED) {
  function knxUltimateHueAreaMotion (config) {
    ...
    node.dptAreaMotion = config.dptAreaMotion
    node.motionDPT = (config.dptAreaMotion && config.dptAreaMotion !== '') ? config.dptAreaMotion : '1.001'
  ...
  RED.nodes.registerType('knxUltimateHueAreaMotion', knxUltimateHueAreaMotion)
}
