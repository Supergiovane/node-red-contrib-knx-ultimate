// Canonical private runtime profile for HUE Controller: device_software_update.
  ...
  function knxUltimateHuedevice_software_update (config) {
    ...
    node.handleSendHUE = (_event) => {
      try {
        ...
        pushStatus({ fill: 'red', shape: 'dot', text: `HUE->KNX error ${error.message} (${formatTs(new Date())})` })
      }
    }
