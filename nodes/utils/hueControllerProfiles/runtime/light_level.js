// Canonical private runtime profile for HUE Controller: light_level.
        ...
        if (_event.id === config.hueDevice) {
          ...
          if (_event.hasOwnProperty('light') && _event.light.hasOwnProperty('light_level')) {
            ...
            if (knxMsgPayload.topic !== '' && knxMsgPayload.topic !== undefined) {
              safeSendToKNX({ grpaddr: knxMsgPayload.topic, payload: knxMsgPayload.payload, dpt: knxMsgPayload.dpt, outputtype: 'write' }, 'write')
            }
