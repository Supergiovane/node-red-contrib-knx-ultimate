...
const buildKnxAiScheduleMarkdown = (store, { now = Date.now() } = {}) => {
  const target = normalizeKnxAiScheduleStore(store, { now })
  const lines = [
    '# Cerebrum Ultimate Plans and Reminders',
    '',
    'This file is generated by Cerebrum Ultimate. Manage these tasks in natural-language chat; the JSON file is the authoritative runtime state.',
    '',
