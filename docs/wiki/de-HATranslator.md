...
> Nutze in Version 8 **KNX Utility** und wähle **Home Assistant Translator**. Die folgenden Einstellungen beschreiben diese Funktion. Der alte separate Knoten ist nicht mehr enthalten.
>
