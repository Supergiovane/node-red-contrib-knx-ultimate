...
2. Array semplice per la registrazione
: payload (array): contiene tutto il gas e può essere formattato/ordinato secondo necessità.
3. Coda di messaggi (dashboard)
