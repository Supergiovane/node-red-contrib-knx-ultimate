...
> Nutze in Version 8 **KNX Utility** und wähle **Load Control**. Die folgenden Einstellungen beschreiben diese Funktion. Der alte separate Knoten ist nicht mehr enthalten.
>
