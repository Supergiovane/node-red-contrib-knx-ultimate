...
In this example, you can see how the Viewer works.

Just put a Viewer node in your flow and attach a Template UI node behind it.

The **template** node (Dashboard's Template UI) contains the default text:
