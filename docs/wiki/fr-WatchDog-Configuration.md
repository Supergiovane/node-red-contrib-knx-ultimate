...
> Dans la version 8, utilisez **KNX Utility** et choisissez **WatchDog**. Les réglages ci-dessous décrivent cette fonction. L’ancien nœud séparé n’est plus inclus.
>
...
|Propriété |Description |
|-------- |----------- |
|Réessier l'intervalle (en quelques secondes) |Le nœud envoie un télégramme au bus KNX à ce temps Interina, en quelques secondes.|
