...
<p> Dieser Knoten funktioniert mit dem Knoten des Knoten -Red -Dashboards <b> Ui_Template </b>.<br/>
Zeigen Sie alle Gruppenadressen und deren Werte in der Dashboard -Montage an.<br/>
</p>
...
1. Gruppenadresse (Dashboard)
: Payload (HTML): Direkt mit der <b> -Schabat </b> Knoten des Dashboards herstellen; Generieren Sie eine Tabelle, die alle Gas und Werte enthält.
2. Einfaches Array für die Aufnahme
: Nutzlast (Array): Enthält alles Gas und kann bei Bedarf formatiert/sortiert werden.
3. Message Warteschlange (Dashboard)
: Payload (HTML): Verbindung zu <b> Vorlage </b>;Zeigt die KNX -Send -Warteschlange an, um die Busstaus zu überwachen.
