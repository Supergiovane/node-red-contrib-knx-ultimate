...
> Dans la version 8, utilisez **KNX Utility** et choisissez **Load Control**. Les réglages ci-dessous décrivent cette fonction. L’ancien nœud séparé n’est plus inclus.
>
