...
|打开行为|打开时，它设置了灯的行为。您可以从不同的行为中进行选择。 <br/> \*\*选择颜色：\*\*将使用您选择的颜色打开灯。要更改颜色，只需单击颜色选择器（&#x5728;_&#x9009;择颜&#x8272;_&#x63A7;制下）。 <br/> \*\*选择温度和亮度： **您选择的温度（kelvin）和亮度（0-100）将打开灯。 <br/> <br/> none：** 无：如果您启用夜间照明，夜间结束后，灯将恢复白天设置的颜色/温度/亮度状态。|
