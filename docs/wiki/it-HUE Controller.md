...
- Editor Luce resiliente: Locate e il contenitore delle mappature vengono inizializzati prima dei widget opzionali Effetti e schede. Un errore nel browser genera un messaggio Node-RED fisso con fase e dettaglio tecnico, invece di lasciare l'editor vuoto e silenzioso.
