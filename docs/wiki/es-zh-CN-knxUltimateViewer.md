🌐 Language: [EN](/node-red-contrib-knx-ultimate/wiki/knxUltimateViewer) | [IT](/node-red-contrib-knx-ultimate/wiki/it-knxUltimateViewer) | [DE](/node-red-contrib-knx-ultimate/wiki/de-knxUltimateViewer) | [FR](/node-red-contrib-knx-ultimate/wiki/fr-knxUltimateViewer) | [ES](/node-red-contrib-knx-ultimate/wiki/es-knxUltimateViewer) | [简体中文](/node-red-contrib-knx-ultimate/wiki/zh-CN-knxUltimateViewer)
<!-- NAV START -->
...
2. Array simple para grabar
: carga útil (matriz): contiene todo el gas y puede formatearse/ordenarse según sea necesario.
3. Cola de mensajes (tablero)
: carga útil (html): conectarse a <b> plantilla </b>;Muestra la cola de envío KNX para monitorear la congestión del bus.
# Ejemplo
...
Coloque el espectador en el proceso y conecte un tablero <b> plantilla </b>.El contenido del nodo <b> plantilla </b> es el siguiente:```
<div ng-bind-html="msg.payload"></div>
```Diagrama de salida: <br/> <img src = "https://raw.githubusercontent.com/supergiovane/node-red-contrib-knx-ultimate/master/img/wiki/viewer1.png" ancho = "90%"> <br/>
<Br />
**Copie el siguiente código al proceso**
> Ajuste los nodos de acuerdo con su entorno````json
