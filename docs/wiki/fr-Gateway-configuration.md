...
> • KNX/IP Secure et Data Secure ne s’appliquent qu’aux transports IP (Tunnel TCP / routage sécurisé) ; le mode Serial FT1.2 n’utilise pas ces paramètres de sécurité.
