...
| Zeilenfelder | 1) Gruppenadresse 2) Datapoint 3) Default-Wert in der Szene (durch Scene Save überschreibbar). Darunter: Gerätename. <br/> <br/> Eine Pause einfügen: **wait ** im ersten Feld und eine Zahl im letzten Feld (Millisekunden), z. B. `2000`. <br/> <br/> **wait** akzeptiert auch Sekunden/Minuten/Stunden: `12s`, `5m`, `1h`.  |
