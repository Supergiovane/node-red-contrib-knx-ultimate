...
> Nutze in Version 8 **KNX Utility** und wähle **WatchDog**. Die folgenden Einstellungen beschreiben diese Funktion. Der alte separate Knoten ist nicht mehr enthalten.
>
> [KNX Utility]({{ '/wiki/de-KNX-Utility' | relative_url }}) · [Upgrade von Version 7]({{ '/wiki/de-Migration-8' | relative_url }})
