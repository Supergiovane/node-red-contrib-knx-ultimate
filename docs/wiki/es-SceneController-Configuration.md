...
> En la versión 8 usa **KNX Utility** y selecciona **Scene Controller**. Los ajustes siguientes describen esa función. El antiguo nodo separado ya no está incluido.
>
