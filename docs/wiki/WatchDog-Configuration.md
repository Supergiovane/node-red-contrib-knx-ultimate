...
translation_key: "WatchDog-Configuration"
---

> In version 8, use **KNX Utility** and select **WatchDog**. The settings below describe this function. The old separate node is no longer included.
>
