...
**Check level ** > _**Ethernet** _ : \*Chechks the connection between knx-ultimate Gateway in unicast mode and your KNX IP Interface.<br />
...
<a href="/node-red-contrib-knx-ultimate/wiki/WatchDog-Configuration"
