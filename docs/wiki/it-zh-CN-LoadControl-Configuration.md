...
# Nodo di controllo del carico KNX
 Utilizzando il nodo di controllo del carico, è possibile gestire automaticamente la disconnessione del carico (lavatrice, forno, ecc.) Quando il consumo corrente supera una determinata soglia.
