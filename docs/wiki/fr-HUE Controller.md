...
- Éditeur Lampe résilient : Locate et le conteneur de mappage sont initialisés avant les widgets facultatifs Effets et onglets. Une erreur côté navigateur produit un message Node-RED fixe avec l'étape et le détail technique au lieu de laisser l'éditeur vide et silencieux.
