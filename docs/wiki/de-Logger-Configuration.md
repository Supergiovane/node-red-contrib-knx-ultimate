...
translation_key: "Logger-Configuration"
---

> Nutze in Version 8 **KNX Utility** und wähle **Logger**. Die folgenden Einstellungen beschreiben diese Funktion. Der alte separate Knoten ist nicht mehr enthalten.
>
