...
```
> You'll expect a "response" from the KNX bus, that you can read using a knx-ultimate node set to react to "response" messages. [Please see the node config wiki](https://github.com/Supergiovane/node-red-contrib-knx-ultimate/wiki/2.-Node-Configuration)
